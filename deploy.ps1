# CrowdStrike Sentinel Connector - Master Deployment Script
...
Write-Host "  • Data Collection Rule (DCR)" -ForegroundColor White
...
Write-Host "[2/4] Deploying infrastructure (DCE and DCR)..." -ForegroundColor Cyan
try {
...
2. Check Sentinel Log Analytics for data in these tables:
...
3. Run this KQL query in Sentinel to verify data ingestion:
   union CrowdStrike*

...
# Note: Polling configuration is optional and not deployed
# Connectors contain all necessary API configuration

# Clean up temporary files
Remove-Item "definition_temp.json" -ErrorAction SilentlyContinue
Remove-Item "polling_temp.json" -ErrorAction SilentlyContinue

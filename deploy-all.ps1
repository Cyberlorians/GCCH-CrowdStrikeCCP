...
$isGovCloud = $config.subscription_id -match "^9661e5a9" # Simple heuristic
...
$connectors = @(
    @{Name="Vulnerabilities"; File="deploy-vulnerabilities.json"},
    @{Name="Alerts"; File="deploy-alerts.json"},
    @{Name="Incidents"; File="deploy-incidents.json"},
    @{Name="Detections"; File="deploy-detections.json"},
    @{Name="Hosts"; File="deploy-hosts.json"}
)
